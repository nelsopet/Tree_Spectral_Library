...
write.csv(PFT_IMG_SPEC_clean_tall, "M:/MSGC_DATA/PEF-Demerit/Spectral_libraries/Clean_PEF_spec_lib_tall.csv")

####VISUALIZATION####
jpeg("M:/Tree_Spectral_Library/Outputs/Spectral_profiles/all.jpg", height = 10000, width = 9000, res = 350)
ggplot(PFT_IMG_SPEC_clean_tall, aes(Wavelength, Median_Reflectance, group = Species), scales = "fixed")+
  labs(title = c("Reflectance by species with median (red), 75% (dark) and 90% (grey) quantiles"), y="Reflectance")+
